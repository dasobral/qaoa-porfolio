...
class TestConfiguration:
    ...
    def test_mock_config_with_test_settings(self):
        ...
        test_settings = {
            "data_sources": {"cache_enabled": False, "free_tier_mode": True},
...
class TestMarketDataMocking:
    ...
    def test_yfinance_mocking(self, mock_yf):
        ...
        # Test that the mock works; we're just testing the mock setup,
        # not the full async call
