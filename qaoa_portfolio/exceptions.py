...
This module defines custom exceptions used throughout the portfolio
...
class VisualizationError(QAOAPortfolioError):
    """Exception raised for visualization configuration or chart-data errors."""

    pass


class BenchmarkError(QAOAPortfolioError):
    """Exception raised for benchmark configuration or execution errors."""
